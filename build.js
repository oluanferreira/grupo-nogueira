...
.quote-contact-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.quote-flow .quote-field{gap:6px}.quote-flow .quote-field label{font-size:11px;color:#dfe7f3}.quote-flow .quote-field label span{color:#7f91ad;font-weight:500}.quote-flow .quote-field input{padding:12px;border-radius:11px;background:rgba(255,255,255,.055);font-size:13px}.quote-field-email{margin-top:10px}.quote-summary{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:14px;padding:11px 13px;border:1px solid rgba(249,115,22,.32);border-radius:12px;background:rgba(249,115,22,.07)}.quote-summary small{display:block;color:#98a9be;font-size:10px}.quote-summary strong{display:block;margin-top:3px;color:#fff;font-size:13px}.quote-change{border:0;background:transparent;color:var(--orange-2);font:inherit;font-size:11px;font-weight:700;cursor:pointer}.quote-actions{display:grid;grid-template-columns:.72fr 1.28fr;gap:9px;margin-top:16px}.quote-actions .btn{width:100%;min-height:47px}.quote-status{margin-top:13px!important;min-height:18px!important;font-size:11px!important}.quote-status[data-state="ready"]{color:#c5f6d5}.quote-status[data-state="error"]{color:#fdba74}
 @media(max-width:1080px){.hero-v2-side{display:grid;gap:18px;min-height:auto}.hero-v2 .hero-quote{max-width:700px;padding-top:0}}
 @media(max-width:620px){.hero-v2 .quote-flow{padding:20px}.quote-flow-title{margin-top:18px}.quote-flow-title h2{font-size:25px}.quote-product-choice{grid-template-columns:1fr;gap:8px}.quote-product-option{min-height:58px}.quote-contact-grid{grid-template-columns:1fr}.quote-actions{grid-template-columns:1fr 1.5fr}.hero-v2 .hero-quote{padding-top:0}}
...
.product-media .product-photo{position:absolute;inset:0;width:100%;height:100%;display:block;object-fit:cover;object-position:center;filter:saturate(.9) contrast(1.04)}
 @media(max-width:1080px){.hero-v2 .hero-inner{grid-template-columns:1fr;gap:30px}.hero-v2 .hero-copy{max-width:720px}.hero-v2-side{max-width:700px;width:100%}.hero-v2 .hero-quote{max-width:700px;width:100%}.product-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.product-card{min-height:360px}}
 @media(max-width:620px){.hero-v2 .hero-inner{padding:26px 0 34px;gap:22px}.hero-v2 .hero-copy p{font-size:15px}.hero-v2 .hero-actions .btn{min-height:54px}.hero-v2 .quote-form{padding:20px}.hero-v2 .hero-quote::before{inset:-10px -8px 10px 8px}.hero-v2-side{gap:14px}.products{padding:72px 0 76px}.products-head{display:block}.products-intro{margin-top:18px}.product-grid{grid-template-columns:1fr 1fr;gap:12px;margin-top:30px}.product-card{min-height:348px}.product-media{height:150px}.product-card-body{padding:18px 15px 16px}.product-card h3{font-size:16px}.product-card p{font-size:13px}.product-list span{font-size:11px;padding:4px 7px}.product-link{font-size:11px}.product-media .truck-real,.product-media .truck-protection-pass{object-fit:cover;object-position:center center}}
@media(max-width:390px){.product-grid{grid-template-columns:1fr}.product-card{min-height:320px}}

 /* Head quote card — superfície navy tonal, hierarquia leve e detalhe premium */
 .hero-v2-side{display:flex;align-items:center;justify-content:flex-end;min-height:620px}
 .hero-v2-side::before{content:"";position:absolute;z-index:0;right:-118px;top:50%;width:520px;height:520px;transform:translateY(-50%);border-radius:50%;background:radial-gradient(circle,rgba(53,106,136,.22) 0%,rgba(11,31,51,0) 68%);pointer-events:none}
 .hero-v2 .hero-quote{width:100%;max-width:468px;margin-left:auto;padding-top:0;position:relative;z-index:2}
 .hero-v2 .hero-quote::before,.hero-v2 .hero-quote::after{display:none}
 .hero-v2 .quote-card{position:relative;display:flex;flex-direction:column;gap:0;max-width:468px;padding:25px 24px 19px;overflow:hidden;border:1px solid rgba(243,239,231,.20);border-radius:24px;background:radial-gradient(140% 100% at 100% 0%,rgba(53,106,136,.22) 0%,rgba(53,106,136,0) 44%),linear-gradient(145deg,#163d5a 0%,#102a43 48%,#0b1f33 100%);color:#F3EFE7;box-shadow:0 29px 62px rgba(0,0,0,.32),0 0 0 1px rgba(232,111,44,.14);backdrop-filter:none}
 .hero-v2 .quote-card::before{content:"";position:absolute;left:24px;top:0;width:89px;height:2px;border-radius:99px;background:#E86F2C;box-shadow:0 0 22px rgba(232,111,44,.38);pointer-events:none}
 .hero-v2 .quote-card::after{content:"";position:absolute;right:-94px;top:-110px;width:252px;height:252px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,.11),rgba(255,255,255,0) 68%);pointer-events:none}
 .quote-card-head{display:flex;align-items:center;gap:10px;position:relative;z-index:1}.quote-card-mark{display:grid;place-items:center;width:36px;height:36px;flex:none;border-radius:10px;background:#0B1F33;box-shadow:0 8px 16px rgba(0,0,0,.24),0 0 0 1px rgba(232,111,44,.22);padding:7px}.quote-card-mark img{display:block;width:100%;height:100%;object-fit:contain}.quote-card-head-copy strong{display:block;font-family:'Plus Jakarta Sans',Inter,sans-serif;font-size:18px;line-height:1.15;color:#F3EFE7;letter-spacing:-.015em}.quote-card-head-copy span{display:block;margin-top:3px;color:#B9C9D3;font-size:10px;line-height:1.3}
 .quote-card-fields{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:17px;position:relative;z-index:1}.quote-card-field{gap:5px}.quote-card-field-full{grid-column:1/-1}.quote-card .quote-field label{font-size:9px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:#D7E3EA}.quote-card .quote-field label span{font-weight:600;color:#A8BBC8;text-transform:none;letter-spacing:0}.quote-card .quote-field input,.quote-card .quote-field select{min-height:38px;width:100%;padding:9px 12px;border:1px solid rgba(243,239,231,.22);border-radius:999px;background:rgba(11,31,51,.46);color:#F3EFE7;font-size:11px;outline:none;box-shadow:inset 0 1px 2px rgba(0,0,0,.16);transition:border-color .2s,box-shadow .2s,background .2s}.quote-card .quote-field input::placeholder{color:#93A8B8}.quote-card .quote-field input:focus,.quote-card .quote-field select:focus{border-color:#E86F2C;background:rgba(11,31,51,.70);box-shadow:0 0 0 3px rgba(232,111,44,.18),inset 0 1px 2px rgba(0,0,0,.16)}.quote-card .quote-field select{appearance:none;cursor:pointer;background-image:linear-gradient(45deg,transparent 50%,#E86F2C 50%),linear-gradient(135deg,#E86F2C 50%,transparent 50%);background-position:calc(100% - 15px) 16px,calc(100% - 10px) 16px;background-size:5px 5px,5px 5px;background-repeat:no-repeat;padding-right:30px}.quote-card .quote-field select option{color:#0B1F33}
 ...
 /* Quote card scale — card inteiro ampliado em 20%, mantendo a composição responsiva */
 .hero-v2 .hero-quote{max-width:468px}
 .hero-v2 .quote-card{max-width:468px;padding:25px 24px 19px;border-radius:24px;box-shadow:0 29px 62px rgba(0,0,0,.32),0 0 0 1px rgba(232,111,44,.14)}
 .hero-v2 .quote-card::before{left:24px;width:89px;box-shadow:0 0 22px rgba(232,111,44,.38)}
 .hero-v2 .quote-card::after{right:-94px;top:-110px;width:252px;height:252px}
 .quote-card-head{gap:12px}.quote-card-mark{width:43px;height:43px;border-radius:12px;padding:8px;box-shadow:0 10px 19px rgba(0,0,0,.24),0 0 0 1px rgba(232,111,44,.22)}.quote-card-head-copy span{margin-top:4px;font-size:12px}
 .quote-card-fields{gap:11px;margin-top:20px}.quote-card-field{gap:6px}.quote-card .quote-field label{font-size:11px}.quote-card .quote-field input,.quote-card .quote-field select{min-height:46px;padding:11px 14px;font-size:13px}.quote-card .quote-field select{background-position:calc(100% - 18px) 19px,calc(100% - 12px) 19px;background-size:6px 6px,6px 6px;padding-right:36px}
 .quote-card-submit{min-height:50px;margin-top:16px;padding:12px 19px;font-size:14px;box-shadow:0 12px 26px rgba(232,111,44,.24)}.quote-card-submit span{font-size:18px}.quote-card .quote-status{margin-top:10px!important;font-size:11.5px!important}
 @media(max-width:1080px){.hero-v2 .hero-quote{max-width:468px}.hero-v2 .quote-card{max-width:468px}}
 @media(max-width:620px){.hero-v2 .quote-card{padding:22px 19px 18px;border-radius:22px}.quote-card-fields{gap:11px;margin-top:19px}.quote-card-submit{margin-top:14px}.hero-v2 .hero-quote{width:100%;max-width:none}}
 ...
 /* Products — continuidade visual da head e linha laranja integral */
 .products{background:
   radial-gradient(900px 520px at 82% 18%,rgba(34,76,145,.22),transparent 64%),
   radial-gradient(620px 300px at 76% 78%,rgba(249,115,22,.08),transparent 70%),
   linear-gradient(180deg,#071421 0%,#0a1a31 54%,#071421 100%)}
 .products::after{content:"";position:absolute;z-index:0;left:-16%;right:-16%;bottom:7%;height:170px;background:
   linear-gradient(172deg,transparent 42%,rgba(249,115,22,.12) 44%,rgba(249,115,22,.76) 46%,rgba(255,211,168,.96) 47%,rgba(249,115,22,.40) 49%,transparent 52%),
   linear-gradient(172deg,transparent 40%,rgba(249,115,22,.08) 44%,transparent 54%);transform:skewX(-8deg);opacity:.78;filter:blur(.15px);pointer-events:none}
 .product-stage .product-card h3{margin-top:0}
 .product-picker-option{grid-template-columns:minmax(0,1fr) 16px;gap:8px}
</style>`;
    ...
    <div class="hero-v2-side reveal">
      <div class="hero-quote" id="contato">
        <form class="quote-form quote-card" id="quoteForm" data-whatsapp="5532988842933" novalidate>
          <div class="quote-card-head"><span class="quote-card-mark" aria-hidden="true"><img src="/escudo-oficial-web.png" alt=""></span><div class="quote-card-head-copy"><strong>Solicite uma cotação</strong><span>Preencha e receba uma orientação personalizada.</span></div></div>
          <div class="quote-card-fields">
            ...
            <div class="quote-field quote-card-field quote-card-field-full"><label for="quoteEmail">E-mail</label><input id="quoteEmail" name="email" autocomplete="email" type="email" placeholder="seu@email.com" required></div>
    ...
    <div class="product-showcase">
      <div class="product-stage">
        <article class="product-card product-card-mobility is-active reveal" id="product-card-mobility" role="tabpanel" aria-labelledby="product-tab-mobility" data-product-panel="mobilidade">
          ...
          <div class="product-card-body"><h3>Mobilidade</h3><p>Seguro para os veículos e as rotinas que não podem parar.</p><div class="product-list"><span>Auto</span><span>Moto</span><span>Caminhões</span></div><a class="btn product-quote" href="https://wa.me/5532988842933" target="_blank" rel="noreferrer" data-product="Mobilidade">Fazer cotação <span aria-hidden="true">→</span></a></div>
        </article>
        ...
        <article class="product-card product-card-future reveal" id="product-card-future" role="tabpanel" aria-labelledby="product-tab-future" data-product-panel="futuro" hidden>
          ...
          <div class="product-card-body"><h3>Projetos &amp; Futuro</h3><p>Planejamento para realizar seus próximos passos com tranquilidade.</p><div class="product-list"><span>Consórcio</span><span>Viagem</span></div><a class="btn product-quote" href="https://wa.me/5532988842933" target="_blank" rel="noreferrer" data-product="Projetos e Futuro">Fazer cotação <span aria-hidden="true">→</span></a></div>
        </article>
        <article class="product-card product-card-special reveal" id="product-card-special" role="tabpanel" aria-labelledby="product-tab-special" data-product-panel="especial" hidden>
          ...
          <div class="product-card-body"><h3>Pet &amp; Dispositivos</h3><p>Seguros para os companheiros e tecnologias presentes na sua rotina.</p><div class="product-list"><span>Pet</span><span>Celular</span></div><a class="btn product-quote" href="https://wa.me/5532988842933" target="_blank" rel="noreferrer" data-product="Pet e Dispositivos">Fazer cotação <span aria-hidden="true">→</span></a></div>
        </article>
        <article class="product-card product-card-vaccine reveal" id="product-card-vaccine" role="tabpanel" aria-labelledby="product-tab-vaccine" data-product-panel="antifurto" hidden>
          ...
          <div class="product-card-body"><h3>Vacina Antifurto</h3><p>Codificação a laser de peças de caminhão para dificultar o comércio irregular.</p><div class="product-list"><span>Laser</span><span>Pesados</span><span>Rastreabilidade</span></div><a class="btn product-quote" href="https://wa.me/5532988842933" target="_blank" rel="noreferrer" data-product="Vacina Antifurto">Fazer cotação <span aria-hidden="true">→</span></a></div>
        </article>
      </div>
      <div class="product-picker" role="tablist" aria-label="Produtos de seguro"><button class="product-picker-option is-active" id="product-tab-mobility" type="button" role="tab" aria-selected="true" aria-controls="product-card-mobility" data-product-target="mobilidade"><span><strong>Mobilidade</strong></span><span class="product-picker-arrow" aria-hidden="true">→</span></button><button class="product-picker-option" id="product-tab-property" type="button" role="tab" aria-selected="false" aria-controls="product-card-property" data-product-target="patrimonio"><span><strong>Patrimônio</strong></span><span class="product-picker-arrow" aria-hidden="true">→</span></button><button class="product-picker-option" id="product-tab-life" type="button" role="tab" aria-selected="false" aria-controls="product-card-life" data-product-target="vida"><span><strong>Vida &amp; Saúde</strong></span><span class="product-picker-arrow" aria-hidden="true">→</span></button><button class="product-picker-option" id="product-tab-future" type="button" role="tab" aria-selected="false" aria-controls="product-card-future" data-product-target="futuro"><span><strong>Projetos &amp; Futuro</strong></span><span class="product-picker-arrow" aria-hidden="true">→</span></button><button class="product-picker-option" id="product-tab-special" type="button" role="tab" aria-selected="false" aria-controls="product-card-special" data-product-target="especial"><span><strong>Pet &amp; Dispositivos</strong></span><span class="product-picker-arrow" aria-hidden="true">→</span></button><button class="product-picker-option product-picker-option-vaccine" id="product-tab-vaccine" type="button" role="tab" aria-selected="false" aria-controls="product-card-vaccine" data-product-target="antifurto"><span><strong>Vacina Antifurto</strong></span><span class="product-picker-arrow" aria-hidden="true">→</span></button></div>
    </div>
  </div>
</section>`;
...
(() => {
  ...
  form.addEventListener('submit',event=>{
    event.preventDefault();
    if(!form.checkValidity()){form.reportValidity();status.dataset.state='error';status.textContent='Confira nome, e-mail, WhatsApp e seguro escolhido.';return;}
