...
@media(max-width:390px){.product-grid{grid-template-columns:1fr}.product-card{min-height:320px}}
 ...
 .hero-v2 .hero-quote{width:100%;max-width:390px;margin-left:auto;padding-top:0;position:relative;z-index:2}
 .hero-v2 .hero-quote::before,.hero-v2 .hero-quote::after{display:none}
 .hero-v2 .quote-card{position:relative;display:flex;flex-direction:column;gap:0;max-width:390px;padding:21px 20px 16px;overflow:hidden;border:1px solid rgba(243,239,231,.20);border-radius:20px;background:radial-gradient(140% 100% at 100% 0%,rgba(53,106,136,.22) 0%,rgba(53,106,136,0) 44%),linear-gradient(145deg,#163d5a 0%,#102a43 48%,#0b1f33 100%);color:#F3EFE7;box-shadow:0 24px 52px rgba(0,0,0,.32),0 0 0 1px rgba(232,111,44,.14);backdrop-filter:none}
 .hero-v2 .quote-card::before{content:"";position:absolute;left:20px;top:0;width:74px;height:2px;border-radius:99px;background:#E86F2C;box-shadow:0 0 18px rgba(232,111,44,.38);pointer-events:none}
 .hero-v2 .quote-card::after{content:"";position:absolute;right:-78px;top:-92px;width:210px;height:210px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,.11),rgba(255,255,255,0) 68%);pointer-events:none}
 .quote-card-head{display:flex;align-items:center;gap:10px;position:relative;z-index:1}.quote-card-mark{display:grid;place-items:center;width:36px;height:36px;flex:none;border-radius:10px;background:#E86F2C;box-shadow:0 8px 16px rgba(232,111,44,.24);padding:7px}.quote-card-mark img{display:block;width:100%;height:100%;object-fit:contain}.quote-card-head-copy strong{display:block;font-family:'Plus Jakarta Sans',Inter,sans-serif;font-size:15px;line-height:1.15;color:#F3EFE7;letter-spacing:-.015em}.quote-card-head-copy span{display:block;margin-top:3px;color:#B9C9D3;font-size:10px;line-height:1.3}
