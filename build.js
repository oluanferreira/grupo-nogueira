...
.hero-v2 .hero-quote{max-width:390px;margin-left:auto;padding-top:24px}
.hero-v2-side .hero-ecosystem{top:-18px;right:-58px;width:500px;min-height:360px;opacity:.62}
.hero-v2 .hero-quote::before,.hero-v2 .hero-quote::after{display:none}
.hero-v2 .quote-card{display:flex;flex-direction:column;gap:0;max-width:390px;padding:20px 20px 16px;border:1px solid rgba(243,239,231,.88);border-radius:20px;background:#F3EFE7;color:#0B1F33;box-shadow:0 18px 44px rgba(0,0,0,.24),0 0 0 4px rgba(243,239,231,.05);backdrop-filter:none}
.quote-card-head{display:flex;align-items:center;gap:10px}.quote-card-mark{display:grid;place-items:center;width:36px;height:36px;flex:none;border-radius:10px;background:#E86F2C;box-shadow:0 8px 16px rgba(232,111,44,.22);padding:7px}.quote-card-mark img{display:block;width:100%;height:100%;object-fit:contain}.quote-card-head-copy strong{display:block;font-family:'Plus Jakarta Sans',Inter,sans-serif;font-size:15px;line-height:1.15;color:#0B1F33;letter-spacing:-.015em}.quote-card-head-copy span{display:block;margin-top:3px;color:#526575;font-size:10px;line-height:1.3}
.quote-card-fields{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:17px}.quote-card-field{gap:5px}.quote-card-field-full{grid-column:1/-1}.quote-card .quote-field label{font-size:9px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:#26343E}.quote-card .quote-field label span{font-weight:600;color:#6A7882;text-transform:none;letter-spacing:0}.quote-card .quote-field input,.quote-card .quote-field select{min-height:38px;width:100%;padding:9px 12px;border:1px solid rgba(38,52,62,.42);border-radius:999px;background:rgba(255,255,255,.66);color:#0B1F33;font-size:11px;outline:none;box-shadow:inset 0 1px 2px rgba(11,31,51,.04);transition:border-color .2s,box-shadow .2s,background .2s}.quote-card .quote-field input::placeholder{color:#7C8891}.quote-card .quote-field input:focus,.quote-card .quote-field select:focus{border-color:#E86F2C;background:#fff;box-shadow:0 0 0 3px rgba(232,111,44,.18),inset 0 1px 2px rgba(11,31,51,.04)}.quote-card .quote-field select{appearance:none;cursor:pointer;background-image:linear-gradient(45deg,transparent 50%,#356A88 50%),linear-gradient(135deg,#356A88 50%,transparent 50%);background-position:calc(100% - 15px) 16px,calc(100% - 10px) 16px;background-size:5px 5px,5px 5px;background-repeat:no-repeat;padding-right:30px}.quote-card .quote-field select option{color:#0B1F33}
.quote-card-submit{width:100%;min-height:42px;margin-top:13px;border-radius:999px;padding:10px 16px;font-size:12px;background:#E86F2C;box-shadow:0 9px 18px rgba(232,111,44,.20)}.quote-card-submit:hover{background:#D15F21}.quote-card-submit span{font-size:15px;line-height:1;transition:transform .2s}.quote-card-submit:hover span{transform:translateX(3px)}.quote-card .quote-status{margin:8px 0 0!important;min-height:0!important;color:#356A88;font-size:9.5px!important;line-height:1.35;text-align:center}.quote-card .quote-status[data-state="error"]{color:#A34720}.quote-card .quote-status[data-state="ready"]{color:#23664D}
@media(max-width:1080px){.hero-v2 .hero-quote{max-width:420px;padding-top:0}.hero-v2 .quote-card{max-width:390px}.hero-v2-side .hero-ecosystem{position:relative;top:auto;right:auto;width:auto;min-height:250px;opacity:1}}
